...
const imgTransparent1 = "/images/svc-website-redesign/imgTransparent1.png";
...
const imgVector20 = "/images/svc-website-redesign/imgVector20.svg";
const imgVector = "/images/svc-website-redesign/imgVector.svg";
const imgVector1 = "/images/svc-website-redesign/imgVector1.svg";
const imgGroup294 = "/images/svc-website-redesign/imgGroup294.svg";
const imgGroup295 = "/images/svc-website-redesign/imgGroup295.svg";
const img02YouTube = "/images/svc-website-redesign/img02YouTube.svg";
...
export function WebsiteRedesignPage() {
  return (
    <div className="bg-white relative w-[1920px] h-[3040px]">
      ...
      <div className="[word-break:break-word] absolute font-days-one leading-[0] left-[calc(30%-347px)] not-italic text-[#333] text-[50px] top-[156px] tracking-[-1px] uppercase w-[897px]" data-node-id="563:5">
        <p className="mb-0">
      ...
      <div className="absolute h-[69px] left-[229px] top-[349px] w-0" data-node-id="563:6">
      ...
      <div className="absolute contents left-[229px] top-[462px]" data-node-id="563:21">
        <div className="absolute border border-[#333] border-solid content-stretch flex h-[88px] items-center justify-center left-[calc(20%+173px)] px-[20px] py-[10px] rounded-[16px] top-[462px]" data-node-id="563:22" role="button" tabIndex={0} aria-label="See Redesigns">
          <p className="[word-break:break-word] font-rajdhani font-bold leading-[normal] not-italic relative shrink-0 text-[#333] text-[23px] text-center tracking-[-0.46px] uppercase whitespace-nowrap" data-node-id="563:23">
            See Redesigns
          </p>
        </div>
        <div className="absolute bg-[#f4a31d] h-[88px] left-[229px] rounded-[16px] top-[462px] w-[304px]" data-node-id="563:24" />
        <div className="absolute border border-solid border-white h-[74px] left-[236px] rounded-[13px] top-[469px] w-[290px]" data-node-id="563:25" role="button" tabIndex={0} aria-label="Audit My Current Site" />
      ...
      <p className="[word-break:break-word] absolute font-days-one leading-[0] left-[calc(30%-359px)] not-italic text-[#333] text-[50px] top-[938px] tracking-[-1px] uppercase w-[795px]" data-node-id="563:28">
      ...
      <p className="[word-break:break-word] absolute font-days-one leading-[0] left-[calc(50%-743px)] not-italic text-[#333] text-[50px] top-[1582px] tracking-[-1px] uppercase w-[1225px]" data-node-id="568:206">
        <span className="leading-[56.6px]">
      ...
      <div className="absolute bg-[#f4a31d] h-[88px] left-[calc(40%+6px)] rounded-[16px] top-[2344px] w-[372px]" data-node-id="568:286" />
      <div className="absolute border border-solid border-white h-[74px] left-[calc(40%+16px)] rounded-[13px] top-[2351px] w-[352px]" data-node-id="568:287" role="button" tabIndex={0} aria-label="Get Free Website Audit" />
      ...
      <div className="-translate-x-1/2 absolute bottom-0 contents left-1/2" data-node-id="712:475">
        <div className="-translate-x-1/2 absolute flex h-[6px] items-center justify-center left-1/2 top-[2540px] w-[1920px]" data-node-id="712:476">
          <div className="-scale-y-100 flex-none">
            <div className="bg-[#f4a31d] h-[6px] relative w-[1920px]" />
          </div>
        </div>
        <div className="-translate-x-1/2 absolute bg-[#333] h-[494px] left-1/2 top-[2546px] w-[1920px]" data-node-id="712:477" />
        <p className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[normal] left-[calc(50%-75px)] not-italic text-[#f4a31d] text-[16px] top-[3012px] tracking-[-0.32px] uppercase whitespace-nowrap" data-node-id="712:478">
          DK Company projects
        </p>
        <div className="-translate-x-1/2 absolute h-0 left-1/2 top-[3005px] w-[1920px]" data-node-id="712:479">
          <div className="absolute inset-[-0.5px_0]">
            <img alt="" className="block max-w-none size-full" src={imgVector20} />
          </div>
        </div>
        <p className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[normal] left-[calc(30%-255px)] not-italic text-[16px] text-white top-[2686px] tracking-[-0.32px] uppercase whitespace-nowrap" data-node-id="712:480">{`Web Development & Software Company`}</p>
        <div className="absolute h-[64px] left-[322px] top-[2617px] w-[234px]" data-node-id="712:481" data-name="Transparent 1">
        ...
        <div className="[word-break:break-word] absolute font-poppins font-normal leading-[0] left-[calc(50%-240px)] not-italic text-[0px] text-white top-[2613px] tracking-[-0.38px] uppercase w-[279px] whitespace-pre-wrap" data-node-id="712:482">
        ...
        <div className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[0] left-[calc(60%-86px)] not-italic text-[19px] text-white top-[2613px] tracking-[-0.38px] uppercase whitespace-nowrap" data-node-id="712:483">
        ...
        <div className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[0] left-[calc(70%-48px)] not-italic text-[19px] text-white top-[2616px] tracking-[-0.38px] uppercase whitespace-nowrap" data-node-id="712:484">
          <p className="leading-[25px] mb-0">Stalk us. feed your</p>
          <p className="leading-[25px]">creativity</p>
        </div>
        <div className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[0] left-[calc(70%-48px)] not-italic text-[19px] text-white top-[2773px] tracking-[-0.38px] uppercase whitespace-nowrap" data-node-id="712:485">
          <p className="leading-[25px] mb-0">Sign up for the digital kangaroos</p>
          <p className="leading-[25px]">newsletter</p>
        </div>
        <div className="[word-break:break-word] absolute font-poppins font-normal leading-[0] left-[calc(40%-48px)] not-italic text-[0px] text-white top-[2761px] tracking-[-0.38px] uppercase whitespace-nowrap" data-node-id="712:486">
        ...
        <div className="[word-break:break-word] absolute font-poppins font-normal leading-[0] left-[calc(50%-240px)] not-italic text-[0px] text-white top-[2837px] tracking-[-0.38px] uppercase whitespace-nowrap" data-node-id="712:487">
        ...
        <div className="absolute inset-[88.39%_30.1%_10.1%_67.5%]" data-node-id="712:488" data-name="Vector">
          <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgVector} />
        </div>
        <div className="-translate-y-1/2 absolute aspect-[29/29] left-[70.83%] right-[26.77%] top-[calc(50%+1190px)]" data-node-id="712:489" data-name="Vector">
          <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgVector1} />
        </div>
        <div className="absolute inset-[88.39%_23.4%_10.1%_74.21%]" data-node-id="712:490">
          <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup294} />
        </div>
        <div className="absolute inset-[88.39%_20.04%_10.1%_77.56%]" data-node-id="712:494">
          <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup295} />
        </div>
        <div className="absolute contents inset-[88.39%_16.69%_10.1%_80.92%]" data-node-id="712:497" data-name="Layer 3">
          <div className="absolute contents inset-[88.39%_16.69%_10.1%_80.92%]" data-node-id="712:498" data-name="Color">
            <div className="absolute inset-[88.39%_16.69%_10.1%_80.92%]" data-node-id="712:499" data-name="02.YouTube">
              <img alt="" className="absolute block inset-0 max-w-none size-full" src={img02YouTube} />
            </div>
          </div>
        </div>
        <div className="absolute bg-white h-[46px] left-[calc(60%+144px)] rounded-[12px] top-[2842px] w-[274px]" data-node-id="712:502" />
        <div className="absolute bg-[#f4a31d] h-[46px] left-[calc(60%+144px)] rounded-[12px] top-[2901px] w-[114px]" data-node-id="712:503" />
        <p className="[word-break:break-word] absolute font-days-one leading-[25px] left-[calc(70%-31px)] not-italic text-[17px] text-[rgba(0,0,0,0.38)] top-[2852px] tracking-[-0.34px] uppercase whitespace-nowrap" data-node-id="712:504">
          EMAIL ADDRESS
        </p>
        <p className="-translate-x-1/2 [word-break:break-word] absolute font-days-one leading-[25px] left-[calc(70%+9px)] not-italic text-[17px] text-center text-white top-[2911px] tracking-[-0.34px] uppercase whitespace-nowrap" data-node-id="712:505">
          SUBMIT
        </p>
        <p className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[normal] left-[calc(30%-255px)] not-italic text-[16px] text-white top-[3012px] tracking-[-0.32px] uppercase whitespace-nowrap" data-node-id="712:506">
          © Digital Kangaroos | All Rights Reserved 2026
        </p>
        <div className="-translate-x-1/2 [word-break:break-word] absolute contents font-rajdhani font-semibold leading-[normal] left-[calc(90%-220px)] not-italic text-[16px] text-white top-[3012px] tracking-[-0.32px] uppercase whitespace-nowrap" data-node-id="712:507">
          <p className="absolute left-[calc(70%+72px)] top-[3012px]" data-node-id="712:508">
            Cart Potato
          </p>
          <p className="absolute left-[calc(90%-199px)] top-[3012px]" data-node-id="712:509">
            DK SCHOOL
          </p>
        </div>
      </div>
      <PixelHeader />
<div className="absolute contents left-[calc(80%+63px)] top-[47px]" data-node-id="563:55">
        <div className="absolute left-[calc(80%+63px)] size-[170px] top-[47px] z-[15]" data-node-id="563:56">
          <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgEllipse20} />
        </div>
        <div className="absolute left-[calc(80%+68px)] size-[159px] top-[53px] z-[15]" data-node-id="563:57" data-name="sadsaas 1">
