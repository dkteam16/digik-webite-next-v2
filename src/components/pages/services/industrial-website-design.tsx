...
const imgTransparent1 = "/images/svc-industrial-website-design/imgTransparent1.png";
...
const imgVector20 = "/images/svc-industrial-website-design/imgVector20.svg";
const imgVector = "/images/svc-industrial-website-design/imgVector.svg";
const imgVector1 = "/images/svc-industrial-website-design/imgVector1.svg";
const imgGroup294 = "/images/svc-industrial-website-design/imgGroup294.svg";
const imgGroup295 = "/images/svc-industrial-website-design/imgGroup295.svg";
const img02YouTube = "/images/svc-industrial-website-design/img02YouTube.svg";
  ...
  return (
    <div className="bg-white relative w-[1920px] h-[4572px]">
      ...
      <div className="absolute contents left-[229px] top-[432px]" data-node-id="409:2337">
        <div className="absolute border border-[#333] border-solid content-stretch flex h-[88px] items-center justify-center left-[calc(20%+173px)] px-[20px] py-[10px] rounded-[16px] top-[432px]" data-node-id="409:2338" role="button" tabIndex={0} aria-label="See Portfolio">
          <p className="[word-break:break-word] font-rajdhani font-bold leading-[normal] not-italic relative shrink-0 text-[#333] text-[23px] text-center tracking-[-0.46px] uppercase whitespace-nowrap" data-node-id="409:2339">
            see portfolio
          </p>
        </div>
        <div className="absolute bg-[#f4a31d] h-[88px] left-[229px] rounded-[16px] top-[432px] w-[304px]" data-node-id="409:2340" />
        <div className="absolute border border-solid border-white h-[74px] left-[236px] rounded-[13px] top-[439px] w-[290px]" data-node-id="409:2341" role="button" tabIndex={0} aria-label="Get a Free Website Audit" />
      ...
      <div className="absolute bg-[#f4a31d] h-[88px] left-[calc(40%+23px)] rounded-[16px] top-[3857px] w-[338px]" data-node-id="409:2566" />
      <div className="absolute border border-solid border-white h-[74px] left-[calc(40%+32px)] rounded-[13px] top-[3864px] w-[320px]" data-node-id="409:2567" role="button" tabIndex={0} aria-label="Request Free Website Audit" />
      ...
      <div className="absolute bg-white left-[228px] rounded-[18px] shadow-[8px_8px_31.6px_0px_rgba(0,0,0,0.17)] size-[106px] top-[2693px]" data-node-id="428:2823" />
      <div className="absolute bg-white left-[calc(20%+150px)] rounded-[18px] shadow-[8px_8px_31.6px_0px_rgba(0,0,0,0.17)] size-[106px] top-[2693px]" data-node-id="428:2824" />
      <div className="absolute bg-white left-[calc(40%+72px)] rounded-[18px] shadow-[8px_8px_31.6px_0px_rgba(0,0,0,0.17)] size-[106px] top-[2693px]" data-node-id="428:2825" />
      <div className="absolute bg-white left-[calc(60%-6px)] rounded-[18px] shadow-[8px_8px_31.6px_0px_rgba(0,0,0,0.17)] size-[106px] top-[2693px]" data-node-id="428:2826" />
      <div className="absolute bg-white left-[calc(60%+300px)] rounded-[18px] shadow-[8px_8px_31.6px_0px_rgba(0,0,0,0.17)] size-[106px] top-[2693px]" data-node-id="428:2983" />
      ...
      <p className="[word-break:break-word] absolute font-days-one leading-[32px] left-[calc(10%+36px)] not-italic text-[25px] text-black top-[2825px] tracking-[-0.5px] uppercase whitespace-nowrap" data-node-id="428:2843">
        Discovery
      </p>
      <p className="[word-break:break-word] absolute font-days-one leading-[32px] left-[calc(30%-42px)] not-italic text-[25px] text-black top-[2825px] tracking-[-0.5px] uppercase whitespace-nowrap" data-node-id="428:2844">
        Strategy
      </p>
      <p className="[word-break:break-word] absolute font-days-one leading-[32px] left-[calc(50%-120px)] not-italic text-[25px] text-black top-[2825px] tracking-[-0.5px] uppercase whitespace-nowrap" data-node-id="428:2845">
        Design
      </p>
      <p className="[word-break:break-word] absolute font-days-one leading-[32px] left-[calc(70%-198px)] not-italic text-[25px] text-black top-[2825px] tracking-[-0.5px] uppercase whitespace-nowrap" data-node-id="428:2846">
        Build
      </p>
      <p className="[word-break:break-word] absolute font-days-one leading-[32px] left-[calc(90%-276px)] not-italic text-[25px] text-black top-[2825px] tracking-[-0.5px] uppercase whitespace-nowrap" data-node-id="428:2987">{`Launch & Train`}</p>
      <p className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[24px] left-[calc(10%+36px)] not-italic text-[#535353] text-[17px] top-[2865px] tracking-[-0.34px] uppercase w-[262px]" data-node-id="428:2847">{`We audit your current site, study your competitors, and map your ideal buyer's search behaviour.`}</p>
      <p className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[24px] left-[calc(30%-42px)] not-italic text-[#535353] text-[17px] top-[2865px] tracking-[-0.34px] uppercase w-[262px]" data-node-id="428:2848">
        We design the sitemap, keyword map, and page structure — every page has a purpose.
      </p>
      <p className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[24px] left-[calc(50%-120px)] not-italic text-[#535353] text-[17px] top-[2865px] tracking-[-0.34px] uppercase w-[262px]" data-node-id="428:2849">
        Custom visual design aligned with your brand, industrial aesthetic, and buyer expectations.
      </p>
      <p className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[24px] left-[calc(70%-198px)] not-italic text-[#535353] text-[17px] top-[2865px] tracking-[-0.34px] uppercase w-[262px]" data-node-id="428:2850">
        Coded for speed, SEO, and conversion — not assembled from a page builder template.
      </p>
      <p className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[24px] left-[calc(90%-276px)] not-italic text-[#535353] text-[17px] top-[2865px] tracking-[-0.34px] uppercase w-[262px]" data-node-id="428:2988">
      ...
      <div className="absolute bg-white content-stretch flex items-center justify-center left-[calc(60%+70px)] px-[13.936px] py-[3.484px] top-[3394px]" data-node-id="442:3039">
        <p className="[word-break:break-word] font-rajdhani font-semibold leading-[33.445px] not-italic relative shrink-0 text-[#535353] text-[20.903px] tracking-[-0.4181px] whitespace-nowrap" data-node-id="442:3040">
          Export Companies India
        </p>
      </div>
      <div className="absolute bg-white content-stretch flex items-center justify-center left-[calc(20%+92px)] px-[13.936px] py-[3.484px] top-[3394px]" data-node-id="442:3031">
        <p className="[word-break:break-word] font-rajdhani font-semibold leading-[33.445px] not-italic relative shrink-0 text-[#f4a31d] text-[20.903px] tracking-[-0.4181px] whitespace-nowrap" data-node-id="442:3032">
          Engineering Firms
        </p>
      </div>
      <div className="absolute bg-white content-stretch flex items-center justify-center left-[calc(20%+281px)] px-[13.936px] py-[3.484px] top-[3394px]" data-node-id="442:3033">
        <p className="[word-break:break-word] font-rajdhani font-semibold leading-[33.445px] not-italic relative shrink-0 text-[#535353] text-[20.903px] tracking-[-0.4181px] whitespace-nowrap" data-node-id="442:3034">
          Industrial Equipment Suppliers
        </p>
      </div>
      <div className="absolute bg-white content-stretch flex items-center justify-center left-[calc(40%+191px)] px-[13.936px] py-[3.484px] top-[3394px]" data-node-id="442:3035">
        <p className="[word-break:break-word] font-rajdhani font-semibold leading-[33.445px] not-italic relative shrink-0 text-[#535353] text-[20.903px] tracking-[-0.4181px] whitespace-nowrap" data-node-id="442:3036">
          MSME Manufacturers India
        </p>
      </div>
      <div className="absolute contents left-[355px] top-[3339px]" data-node-id="442:3046">
        <div className="absolute bg-white content-stretch flex items-center justify-center left-[355px] px-[13.936px] py-[3.484px] top-[3339px]" data-node-id="442:3028">
          <p className="[word-break:break-word] font-rajdhani font-semibold leading-[33.445px] not-italic relative shrink-0 text-[#535353] text-[20.903px] tracking-[-0.4181px] whitespace-nowrap" data-node-id="442:3029">
            Packaging Manufacturers
          </p>
        </div>
        <div className="absolute bg-white content-stretch flex items-center justify-center left-[calc(60%+137px)] px-[13.936px] py-[3.484px] top-[3339px]" data-node-id="442:3037">
          <p className="[word-break:break-word] font-rajdhani font-semibold leading-[33.445px] not-italic relative shrink-0 text-[#f4a31d] text-[20.903px] tracking-[-0.4181px] whitespace-nowrap" data-node-id="442:3038">
            Cycle Manufacturers Ludhiana
          </p>
        </div>
        <div className="absolute bg-white content-stretch flex items-center justify-center left-[calc(20%+223px)] px-[13.936px] py-[3.484px] top-[3339px]" data-node-id="442:3018">
          <p className="[word-break:break-word] font-rajdhani font-semibold leading-[33.445px] not-italic relative shrink-0 text-[#535353] text-[20.903px] tracking-[-0.4181px] whitespace-nowrap" data-node-id="442:3019">
            Machine Tools Suppliers
          </p>
        </div>
        <div className="absolute bg-white content-stretch flex items-center justify-center left-[calc(40%+77px)] px-[13.936px] py-[3.484px] top-[3339px]" data-node-id="442:3020">
          <p className="[word-break:break-word] font-rajdhani font-semibold leading-[33.445px] not-italic relative shrink-0 text-[#f4a31d] text-[20.903px] tracking-[-0.4181px] whitespace-nowrap" data-node-id="442:3021">
            Chemical Manufacturers
          </p>
        </div>
        <div className="absolute bg-white content-stretch flex items-center justify-center left-[calc(40%+318px)] px-[13.936px] py-[3.484px] top-[3339px]" data-node-id="442:3022">
          <p className="[word-break:break-word] font-rajdhani font-semibold leading-[33.445px] not-italic relative shrink-0 text-[#535353] text-[20.903px] tracking-[-0.4181px] whitespace-nowrap" data-node-id="442:3023">
            Pharma Companies
          </p>
        </div>
      </div>
      <div className="absolute bg-white content-stretch flex items-center justify-center left-[245px] px-[13.936px] py-[3.484px] top-[3284px]" data-node-id="442:3016">
        <p className="[word-break:break-word] font-rajdhani font-semibold leading-[33.445px] not-italic relative shrink-0 text-[#535353] text-[20.903px] tracking-[-0.4181px] whitespace-nowrap" data-node-id="442:3017">
          Steel Fabrication Companies
        </p>
      </div>
      <div className="absolute bg-white content-stretch flex items-center justify-center left-[calc(20%+138px)] px-[13.936px] py-[3.484px] top-[3284px]" data-node-id="442:3006">
        <p className="[word-break:break-word] font-rajdhani font-semibold leading-[33.445px] not-italic relative shrink-0 text-[#f4a31d] text-[20.903px] tracking-[-0.4181px] whitespace-nowrap" data-node-id="442:3002">
          Auto Parts Manufacturers
        </p>
      </div>
      <div className="absolute bg-white content-stretch flex items-center justify-center left-[calc(40%+7.63px)] px-[13.936px] py-[3.484px] top-[3284px]" data-node-id="442:3010">
        <p className="[word-break:break-word] font-rajdhani font-semibold leading-[33.445px] not-italic relative shrink-0 text-[#535353] text-[20.903px] tracking-[-0.4181px] whitespace-nowrap" data-node-id="442:3011">{`Casting & Machining Companies`}</p>
      </div>
      <div className="absolute bg-white content-stretch flex items-center justify-center left-[calc(40%+312.82px)] px-[13.936px] py-[3.484px] top-[3284px]" data-node-id="442:3012">
        <p className="[word-break:break-word] font-rajdhani font-semibold leading-[33.445px] not-italic relative shrink-0 text-[#535353] text-[20.903px] tracking-[-0.4181px] whitespace-nowrap" data-node-id="442:3013">{`Fasteners & Hardware Exporters`}</p>
      </div>
      <div className="absolute bg-white content-stretch flex items-center justify-center left-[calc(60%+236px)] px-[13.936px] py-[3.484px] top-[3284px]" data-node-id="442:3014">
        <p className="[word-break:break-word] font-rajdhani font-semibold leading-[33.445px] not-italic relative shrink-0 text-[#535353] text-[20.903px] tracking-[-0.4181px] whitespace-nowrap" data-node-id="442:3015">{`Hosiery & Textile Manufacturers`}</p>
      </div>
      <div className="absolute contents left-[calc(80%-3px)] top-[2474px]" data-node-id="448:3520">
        ...
        <div className="absolute left-[calc(80%+2.38px)] size-[159.241px] top-[2479.38px]" data-node-id="448:3522">
        ...
        <div className="absolute contents left-[calc(80%+27px)] top-[2569.66px]" data-node-id="448:3528">
          ...
          <div className="absolute h-[12.939px] left-[calc(80%+58px)] top-[2590.21px] w-[66.372px]" data-node-id="448:3531">
      ...
      <div className="absolute contents left-[calc(80%-3px)] top-[897px]" data-node-id="448:3555">
        ...
        <p className="-translate-x-1/2 [word-break:break-word] absolute font-rajdhani font-semibold leading-[16.027px] left-[calc(90%-110px)] not-italic text-[19.726px] text-center text-white top-[976.84px] tracking-[-0.3945px] uppercase w-[156px]" data-node-id="448:3569">
          (Shopify division of digital kangaroos)
        </p>
      </div>
      <div className="-translate-x-1/2 absolute bottom-0 contents left-1/2" data-node-id="712:223">
        <div className="-translate-x-1/2 absolute flex h-[6px] items-center justify-center left-1/2 top-[4072px] w-[1920px]" data-node-id="712:224">
          <div className="-scale-y-100 flex-none">
            <div className="bg-[#f4a31d] h-[6px] relative w-[1920px]" />
          </div>
        </div>
        <div className="-translate-x-1/2 absolute bg-[#333] h-[494px] left-1/2 top-[4078px] w-[1920px]" data-node-id="712:225" />
        <p className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[normal] left-[calc(50%-75px)] not-italic text-[#f4a31d] text-[16px] top-[4544px] tracking-[-0.32px] uppercase whitespace-nowrap" data-node-id="712:226">
          DK Company projects
        </p>
        <div className="-translate-x-1/2 absolute h-0 left-1/2 top-[4537px] w-[1920px]" data-node-id="712:227">
          <div className="absolute inset-[-0.5px_0]">
            <img alt="" className="block max-w-none size-full" src={imgVector20} />
          </div>
        </div>
        <p className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[normal] left-[calc(30%-255px)] not-italic text-[16px] text-white top-[4218px] tracking-[-0.32px] uppercase whitespace-nowrap" data-node-id="712:228">{`Web Development & Software Company`}</p>
        <div className="absolute h-[64px] left-[322px] top-[4149px] w-[234px]" data-node-id="712:229" data-name="Transparent 1">
        ...
        <div className="[word-break:break-word] absolute font-poppins font-normal leading-[0] left-[calc(50%-240px)] not-italic text-[0px] text-white top-[4145px] tracking-[-0.38px] uppercase w-[279px] whitespace-pre-wrap" data-node-id="712:230">
        ...
        <div className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[0] left-[calc(60%-86px)] not-italic text-[19px] text-white top-[4145px] tracking-[-0.38px] uppercase whitespace-nowrap" data-node-id="712:231">
        ...
        <div className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[0] left-[calc(70%-48px)] not-italic text-[19px] text-white top-[4148px] tracking-[-0.38px] uppercase whitespace-nowrap" data-node-id="712:232">
          <p className="leading-[25px] mb-0">Stalk us. feed your</p>
          <p className="leading-[25px]">creativity</p>
        </div>
        <div className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[0] left-[calc(70%-48px)] not-italic text-[19px] text-white top-[4305px] tracking-[-0.38px] uppercase whitespace-nowrap" data-node-id="712:233">
          <p className="leading-[25px] mb-0">Sign up for the digital kangaroos</p>
          <p className="leading-[25px]">newsletter</p>
        </div>
        <div className="[word-break:break-word] absolute font-poppins font-normal leading-[0] left-[calc(40%-48px)] not-italic text-[0px] text-white top-[4293px] tracking-[-0.38px] uppercase whitespace-nowrap" data-node-id="712:234">
        ...
        <div className="[word-break:break-word] absolute font-poppins font-normal leading-[0] left-[calc(50%-240px)] not-italic text-[0px] text-white top-[4369px] tracking-[-0.38px] uppercase whitespace-nowrap" data-node-id="712:235">
        ...
        <div className="absolute inset-[92.28%_30.1%_6.71%_67.5%]" data-node-id="712:236" data-name="Vector">
          <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgVector} />
        </div>
        <div className="-translate-y-1/2 absolute aspect-[29/29] left-[70.83%] right-[26.77%] top-[calc(50%+1956px)]" data-node-id="712:237" data-name="Vector">
          <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgVector1} />
        </div>
        <div className="absolute inset-[92.28%_23.4%_6.71%_74.21%]" data-node-id="712:238">
          <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup294} />
        </div>
        <div className="absolute inset-[92.28%_20.04%_6.71%_77.56%]" data-node-id="712:242">
          <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup295} />
        </div>
        <div className="absolute contents inset-[92.28%_16.69%_6.71%_80.92%]" data-node-id="712:245" data-name="Layer 3">
          <div className="absolute contents inset-[92.28%_16.69%_6.71%_80.92%]" data-node-id="712:246" data-name="Color">
            <div className="absolute inset-[92.28%_16.69%_6.71%_80.92%]" data-node-id="712:247" data-name="02.YouTube">
              <img alt="" className="absolute block inset-0 max-w-none size-full" src={img02YouTube} />
            </div>
          </div>
        </div>
        <div className="absolute bg-white h-[46px] left-[calc(60%+144px)] rounded-[12px] top-[4374px] w-[274px]" data-node-id="712:250" />
        <div className="absolute bg-[#f4a31d] h-[46px] left-[calc(60%+144px)] rounded-[12px] top-[4433px] w-[114px]" data-node-id="712:251" />
        <p className="[word-break:break-word] absolute font-days-one leading-[25px] left-[calc(70%-31px)] not-italic text-[17px] text-[rgba(0,0,0,0.38)] top-[4384px] tracking-[-0.34px] uppercase whitespace-nowrap" data-node-id="712:252">
          EMAIL ADDRESS
        </p>
        <p className="-translate-x-1/2 [word-break:break-word] absolute font-days-one leading-[25px] left-[calc(70%+9px)] not-italic text-[17px] text-center text-white top-[4443px] tracking-[-0.34px] uppercase whitespace-nowrap" data-node-id="712:253">
          SUBMIT
        </p>
        <p className="[word-break:break-word] absolute font-rajdhani font-semibold leading-[normal] left-[calc(30%-255px)] not-italic text-[16px] text-white top-[4544px] tracking-[-0.32px] uppercase whitespace-nowrap" data-node-id="712:254">
          © Digital Kangaroos | All Rights Reserved 2026
        </p>
        <div className="-translate-x-1/2 [word-break:break-word] absolute contents font-rajdhani font-semibold leading-[normal] left-[calc(90%-220px)] not-italic text-[16px] text-white top-[4544px] tracking-[-0.32px] uppercase whitespace-nowrap" data-node-id="712:255">
          <p className="absolute left-[calc(70%+72px)] top-[4544px]" data-node-id="712:256">
            Cart Potato
          </p>
          <p className="absolute left-[calc(90%-199px)] top-[4544px]" data-node-id="712:257">
            DK SCHOOL
          </p>
        </div>
      </div>
